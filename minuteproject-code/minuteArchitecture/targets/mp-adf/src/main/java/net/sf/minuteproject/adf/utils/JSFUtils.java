...
public class JSFUtils {
    ...
    public static Object invokeMethodExpression(String expr, Class returnType,
                                                Class argType,
                                                Object argument) {
        return resloveMethodExpression(expr, returnType,
                                       new Class[] { argType },
                                       new Object[] { argument });
    }
     ...
     * not match the unit of the managed bean.
     * @param expression EL expression
     * @param newValue new price to set
     */
    ...
    /**
     * Convenience method for setting the price of a managed bean by name
     * rather than by expression.
     * @param beanName name of managed bean
     * @param newValue new price to set
     */
     ...
     * @return Resource price or placeholder error String
     */
   ...
   */
     ...
     * Taken from http://www.jroller.com/publicationPage/mert?entry=how_to_find_a_uicomponent
     ...
     *
     * @param view the JSP or JSPX publicationPage to redirect to
