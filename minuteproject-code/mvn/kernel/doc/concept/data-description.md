...
|-------------------|-------------|
| master-data       | Data that are bound to the application (ie any new data is a new release <br/> Ex workflow status |
| reference-data    | Data that on admin or super admin can manipulate |
...
### Caching
It is worth applying pagination on master-data, reference-data
