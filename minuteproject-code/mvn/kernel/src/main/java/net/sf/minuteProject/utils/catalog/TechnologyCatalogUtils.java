...
//			technology.getProperties().addAll(getChoosenTechnology().getProperties());
	...
	private static Target getTarget(Technology technology, String catalogDir, String outputDir, String templateRootDir, boolean isDefaultOutputToAppend) throws MinuteProjectException {
	...
	private static String getTemplateSetFullPath(String fileName, String catalogDir) throws MinuteProjectException {
	...
	private static String getTemplateSetFullPathAndFileName(String fileName, String catalogDir) throws MinuteProjectException {
